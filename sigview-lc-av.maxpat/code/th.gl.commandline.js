...
function drawCursor(){
	crsrMtx.setall(32);
	crsrMtx.setcell2d(curCharacter, 0, 46); // original: crsrMtx.setcell2d(curCharacter, 0, 60);
	// crsrMtx.setcell2d(curCharacter+1, 0, 8230); // original: crsrMtx.setcell2d(curCharacter+1, 0, 61);
}//drawCursor()
...
glText.gl_color = [0.4, 0.4, 0.4, 0.7];
...
var cnt = 0;
var blinkColor = [0.4, 0.4, 0.4, 0.7];
...
function blink(v){
	if (v == 1){
		...
		glCrsr.gl_color = [0.7, 0.7, 0.7, glCrsr.gl_color[3]];
	}
